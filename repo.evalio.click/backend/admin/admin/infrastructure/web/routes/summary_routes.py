...
from admin.di import get_summary_usecase
from admin.domain.manager.usecases.summary_usecase import ISummaryQualificationsUsecase

summary_router = APIRouter(tags=["Summary Router"])


@summary_router.get(
    "/summary",
    description="Useful to get a summary qualifications consolidated by templat",
)
