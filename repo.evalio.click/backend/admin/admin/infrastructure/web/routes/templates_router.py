...
from admin.domain.manager.usecases.templates_usecase import ITemplatesUsecase

template_router = APIRouter(tags=["Template Manager"])


@template_router.get(
    "/template",
    description="Useful to generate template for response sheets," \
    " produce a pdf with the students",
)
async def generate_template(
    ...
    input_usecase = InputGenTemplate(group_id=group_id, template_id=template_id)
...
@template_router.post(
    "/template", description="Useful to create a template for response sheets"
)
...
@template_router.get(
    "/templates", description="Useful to get all templates by professor"
)
async def get_templates(
    group_id: str,
    usecase: Annotated[ITemplatesUsecase,
                       Depends(get_template_usecase)],
):
...
@template_router.delete(
    "/template",
    description="Useful to delete a template by Id",
