...
import (
	...
	logger "github.com/LuisDiazM/evalio/backend/usersManager/domain/shared"
...
func NewProfessorService(repo repositories.IProfessorRepository, logger logger.Logger, privateKey, publicKey []byte) IProfessorService {
