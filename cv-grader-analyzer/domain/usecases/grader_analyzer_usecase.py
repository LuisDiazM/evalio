...
class GraderAnalyzerUsecase(IGraderAnalyzerUseCase):
    ...
    def analyze(self, exam_id):
        try:
            ...
            summary = self.__create_summary(exam, score, template)
    ...
    def __create_summary(self, exam: Exam, score: float, template_response: TemplateResponses) -> SummaryQualifications:
